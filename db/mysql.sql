...
(
    `id`                     bigint(20)   NOT NULL AUTO_INCREMENT,
    `order_no`               varchar(200) NOT NULL COMMENT '执行单号',
    `customer_name`          varchar(200) NOT NULL COMMENT '客户名称',
    `project_name`           varchar(200) NOT NULL COMMENT '项目名称',
    `amount`                 int(10)     DEFAULT NULL COMMENT '金额',
    `book_user`              varchar(20) DEFAULT NULL COMMENT '下单人',
    `book_user_phone`        varchar(20) DEFAULT NULL COMMENT '下单人电话',
    `customer_manager`       varchar(20) DEFAULT NULL COMMENT '客户管理员名称',
    `customer_manager_phone` varchar(20) DEFAULT NULL COMMENT '客户管理员电话',
    `agent`                  varchar(50) DEFAULT NULL COMMENT '代理商',
    `agent_phone`            varchar(20) DEFAULT NULL COMMENT '代理商电话',
    `book_time`              datetime    DEFAULT CURRENT_TIMESTAMP COMMENT '下单时间',
